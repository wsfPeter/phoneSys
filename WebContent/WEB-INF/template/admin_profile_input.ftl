...
<link href="${base}/template/css/admin.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${base}/template/js/jquery.validate.methods.js"></script>
<script type="text/javascript" src="${base}/template/js/base.js"></script>
<script type="text/javascript" src="${base}/template/js/admin.js"></script>
	...
	<div class="body">
		<form id="validateForm" action="admin_profile!update.action" method="post">
			...
			<div class="buttonArea">
				...
				<input type="button" class="formButton" onclick="window.location='page!index.action';" value="返  回" hidefocus/>
			</div>
		</form>
	</div>
</body>
